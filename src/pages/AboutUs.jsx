        ...
        <div className="relative z-[1] max-w-site mx-auto px-6 flex flex-col gap-10">
          ...
          <div className="max-w-[680px] mx-auto w-full">
            <p className="text-[15px] text-white/70 leading-[1.85] mb-4">
              <span className="float-left text-[52px] font-extrabold text-white leading-[0.85] mr-2 mt-1">W</span>
              e're a small, focused team of engineers, developers, and designers united by one purpose, making
              CAD automation practical, powerful, and accessible for every organization.
            </p>
            <p className="text-[15px] text-white/70 leading-[1.85]">
              Having lived the frustration of slow, manual CAD processes, we built{' '}
              <strong className="text-white font-bold">DakshCWM</strong> to give engineers their time
              back. We believe the future of engineering is not better design tools, it is{' '}
              <strong className="text-white font-bold">better automation</strong>.
            </p>
          </div>
          ...
          <div className="bg-card-bg border border-white/[0.08] rounded-xl p-8 max-w-[680px] mx-auto w-full transition-all hover:border-[rgba(0,180,255,0.2)]">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-7">
              ...
              {/* Text */}
              <div>
                <h2 className="text-[22px] font-extrabold text-white mb-3 leading-[1.25]">Who We Are</h2>
                <p className="text-[14px] text-muted leading-[1.8]">
                  At <strong className="text-white font-semibold">DakshCWM</strong>, we believe engineers should spend
                  their energy on <strong className="text-white font-semibold">design and innovation</strong>, not repetitive
                  clicks. Our combined experience in mechanical design, automation, and software engineering helps
          ...
          <div className="bg-card-bg border border-white/[0.08] rounded-xl px-9 py-10 max-w-[680px] mx-auto w-full transition-all hover:border-[rgba(0,180,255,0.2)]">
            <h2 className="text-[22px] font-extrabold text-white mb-4 text-center">What We Do</h2>
            ...
            <ul className="flex flex-col gap-2.5 mb-5">
              {[
                ...
                <li key={item} className="flex items-center gap-2.5 text-[13px] text-white/75 font-medium">
