    ...
    <main className="bg-site-bg">
      ...
      <section className="bg-cta-grad border-t border-white/[0.08] py-[90px] text-center">
        <div className="max-w-site mx-auto px-6">
          ...
          <button className="m-4 text-[15px] font-bold px-10 py-[14px] bg-[#4a3afd] text-white rounded cursor-pointer transition-all hover:bg-[#33c4ff] hover:shadow-accent-glow hover:-translate-y-[5px]">
            Try Free Today
          </button>

          <button className="m-4 text-[15px] font-bold px-10 py-[14px] bg-transparent text-white border border-1 rounded cursor-pointer transition-all hover:bg-[#33c4ff] hover:shadow-accent-glow hover:-translate-y-[5px]">
            Schedule Demo
          </button>
        </div>
      </section>
