        ...
        <div className="max-w-[720px] mx-auto">
          <div className="bg-card-bg border border-white/[0.08] rounded-xl px-9 py-12 transition-all hover:border-[rgba(0,180,255,0.1)]">
            ...
            <p className="text-[14px] text-muted leading-[1.75] mb-10">
              This Privacy Policy explains how DakshCWM collects, uses, and
              protects information when you use our website, desktop agent, and
              workflow automation services. By using DakshCWM you agree to the
              ...
              {[
                {
                  ...
                  rest: " name, email address, company name, role, and user credentials.",
                },
                {
                  bold: "Workflow and usage information:",
                  rest: " the workflows you run, file names involved in automation, timestamps, execution logs, and workflow success or failure messages.",
                },
                {
                  bold: "System information:",
                  rest: " SolidWorks version, operating system details, agent version, and hardware identifiers used for compatibility and troubleshooting.",
                },
                {
                  bold: "Support interactions:",
                  rest: " messages sent to support, uploaded screenshots, and diagnostic logs if you choose to share them.",
                },
                {
                  bold: "Website analytics:",
                  rest: " anonymous data such as IP address, browser type, pages visited, and time spent on pages.",
                },
              ].map(({ bold, rest }) => (
                <li
                  key={bold}
                  className="flex items-start gap-2.5 text-[14px] text-muted leading-[1.75]"
                >
                  <span className="text-accent font-bold flex-shrink-0 mt-[2px]">
                    •
                  </span>
                  <span>
            ...
            <p className="text-[14px] text-muted leading-[1.75] mb-4">
              The desktop agent executes workflows directly on the user's
              workstation. This means:
            </p>
            <ul className="flex flex-col gap-3 mb-10">
              {[
            ...
            <p className="text-[14px] text-muted leading-[1.75] mb-10">
              We retain information only as long as needed for service
              operation, support, legal, and audit obligations. You may request
            ...
            <p className="text-[14px] text-muted leading-[1.75] mb-10">
              DakshCWM is not intended for children under 16. We do not
            ...
            <p className="text-[14px] text-muted leading-[1.75] mb-10">
              We may update this Privacy Policy to reflect product changes or
              legal requirements. We will update the date at the top when
              changes are made.
            </p>
