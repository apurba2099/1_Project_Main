  ...
  return (
    <>
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-2.5 px-[14px] py-[11px] rounded-[10px] border text-sm font-medium text-white/80 transition-all duration-200 mb-5 font-inter
          ${googleHover ? "bg-white/[0.09] border-white/20" : "bg-white/5 border-white/10"}`}
      >
        <GoogleIcon />
      ...
      {/* Divider */}
      <div className="flex items-center gap-3 my-0 mb-5">
        <div className="flex-1 h-px bg-white/[0.08]" />
        <span className="text-[11px] text-white/35 font-medium tracking-wider">
          OR
        </span>
        <div className="flex-1 h-px bg-white/[0.08]" />
      </div>
